# Revolución, Lucha Antiagraria, Reforma Agraria y la Economía Chiclera en Hopelchén (1910–1970): La Tierra Se Redistribuye, el Chicle Se Explota
...
### Bloque 004-A — 1910–1915: La Revolución llega a Hopelchén — el municipio libre y la c

| Campo | Valor |
|---|---|
| **Tipo** | Citado con reserva — los hacendados antiagrarios de Hopelchén no están nominados en fuentes consultadas |
| **Fecha / Período** | 1910–1915 |
...
_Origen: Wikipedia — Hopelchén / Revolución Mexicana_
**⚠ Nota/contradicción:** La Revolución Mexicana es presentada en la narrativa nacional como la gran redistribución de poder y tierra. En Hopelchén, la clase hacendaria resistió activamente — lo que significa que la Revolución fue aquí un proceso conflictivo y tardío, no una transformación inmediata. Las grandes haciendas ca
**→ Conexión hipótesis:** El patrón se confirma: cada cambio de régimen político (Independencia 1821, Revolución 1910) que prometía redistribuir el poder fue resistido por la élite local de Hopelchén y produjo cambios superfic
**Etiquetas:** Revolución 1910, lucha antiagraria, Hopelchén, municipio libre 1915, Artículo 27, hacendados, Pedro Advíncula Lara, resistencia élite local

---


### Bloque 004-B — 1917–1930: Reforma Agraria en Campeche — dotación de ejidos y las haci

| Campo | Valor |
|---|---|
| **Tipo** | Citado académico — datos verificables en DOF y RAN |
| **Fecha / Período** | 1917–1930 |
| **Lugar** | Campeche — Hopelchén |
...
_Origen: El Bable — La antigua hacienda de Dzibalchén (cita resolución presidencial) <http://vamonosalbable.blogspot.com/2020/09/la-antigua-hacienda-de-dzibalchen.html>_
**⚠ Nota/contradicción:** Las tierras dotadas a Dzibalchén en 1927 eran 'de mala calidad, no útiles para agricultura' — lo que forzó a los ejidatarios a trabajar en la industria chiclera. Esto es una forma de redistribución nominal que no cambió la dependencia económica real. Se dio tierra, pero tierra inútil. El poder sobre
**→ Conexión hipótesis:** La Reforma Agraria en Los Chenes fue un simulacro parcial: se dotaron ejidos, pero de tierras de baja calidad. Los recursos valiosos (selva, chicle, maderas) quedaron bajo el control de concesionarios
**Etiquetas:** Reforma Agraria, Dzibalchén 1927, 6671 hectáreas, 236 ejidatarios, tierras de mala calidad, chicle, dependencia, 67 predios 73.8%, haciendas sobreviven

---


### Bloque 004-C — 1900–1950: La economía chiclera en Los Chenes — estructura de explotac

| Campo | Valor |
|---|---|
| **Tipo** | Citado académico — alta confiabilidad |
| **Fecha / Período** | 1900–1950 |
...
### Bloque 004-D — 1930–1947: Cárdenas, cooperativas y la expropiación chiclera — el Esta

| Campo | Valor |
|---|---|
| **Tipo** | Citado académico |
| **Fecha / Período** | 1930–1947 |
| **Lugar** | Los Chenes — Campeche — México |
...
**⚠ Nota/contradicción:** En la década de 1930, cuando se retiraron las concesiones a las compañías estadounidenses y se transfirieron a comunidades locales, el ingreso de los productores de chicle aumentó 300% (Este País). Pero este beneficio fue temporal: el chicle fue reemplazado por sustitutos sintéticos en los años 50-6
**→ Conexión hipótesis:** El cardenismo demostró que cuando el Estado rompe el monopolio extranjero sobre un recurso natural, los productores locales se benefician (aumento del 300% en ingresos). Pero cuando ese recurso pierde
**Etiquetas:** Cárdenas, cooperativas chicleras, Héctor Pérez Martínez, sindicato 1941, The Laguna Corporation, expropiación 1947, 10 comunidades Hopelchén, reforma agraria, 300% aumento ingresos, sustitutos sintéticos

---


### Bloque 004-E — 1940–1970: El fin del chicle y el inicio de la crisis — Hopelchén en l

| Campo | Valor |
|---|---|
| **Tipo** | Citado — alta confiabilidad en datos cuantitativos |
| **Fecha / Período** | 1940–1970 |
...
**⚠ Nota/contradicción:** La narrativa del 'fin del chicle' presenta el declive como resultado de fuerzas del mercado internacional (sustitutos sintéticos). Esto es parcialmente cierto — pero Herman Konrad (investigador canadiense) documentó que las compañías extranjeras que explotaron el chicle en Campeche no respetaron cic
**→ Conexión hipótesis:** El ciclo chiclero completa el patrón extractivo: recurso identificado → explotación intensiva por capital externo → agotamiento del recurso → abandono de la región → nueva forma de explotación. Este p
**Etiquetas:** fin del chicle, sustitutos sintéticos, acetato de polivinilo, campos aéreos abandonados, Hopelchén campo aéreo, 1940 auge, 1950 declive, Herman Konrad, un millón chicozapotes, ciclo extractivo, Calakmul 1968

---


### Bloque 004-F — Fuentes literarias y académicas de Los Chenes — el testimonio como his

| Campo | Valor |
|---|---|
| **Tipo** | Bibliográfico — identificación de fuentes primarias |
| **Fecha / Período** | 1938–1985 |
| **Lugar** | Hopelchén — Campeche — México |
...
_Origen: EntreDiversidades — Bestializados y oprimidos: figuraciones del chiclero (Vadillo Buenfil) <https://entrediversidades.unach.mx/index.php/entrediversidades/article/view/442>_
**⚠ Nota/contradicción:** La literatura campechana sobre chicleros los presenta como 'bestializados y oprimidos' — individuos degradados por la selva y por sus patrones. Ponce Jiménez los presenta como trabajadores con agencia, testimonios y cultura propia. La visión académica de testimonios orales contradice la visión liter
**→ Conexión hipótesis:** La memoria oral de los chicleros de Los Chenes es una forma de historia no oficial que contradice la narrativa dominante. El proyecto de Hopelchén debe buscar y registrar esos testimonios antes de que
**Etiquetas:** Aranda González 1985, Ponce Jiménez 1990, CIESAS, La Montaña Chiclera, testimonios orales, Humberto Lara y Lara, Juan de la Cabada, Herman Konrad, historia oral, cuentística campechana

---


### Bloque 004-G — CRUCE DE DATOS: El ciclo extractivo de Hopelchén — un patrón de 500 añ

| Campo | Valor |
|---|---|
| **Tipo** | Análisis estructural — cruce de datos documentados |
| **Fecha / Período** | 1517–1970 |
...
_Origen: Análisis propio — cruce de datos de Nodos 001-004_
