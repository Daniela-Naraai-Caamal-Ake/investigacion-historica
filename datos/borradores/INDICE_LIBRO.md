# Índice del libro — *Dos Mil Años en Silencio*

> Autora: Daniela Naraai Caamal Ake  
> Proyecto: Archivo Vivo — Hopelchén, Campeche, México  
> Última actualización: 2026-04-18  
> DOI: https://doi.org/10.5281/zenodo.19140910

Este archivo es el **mapa editorial del libro**. Lista todos los capítulos en orden,
su estado, el nodo histórico al que corresponden y la palabra estimada.
...
| 📝 | Borrador — pendiente revisión de Dan |
| 🔲 | No iniciado |
...
|---|---|---|---|
| `PRÓLOGO.md` | Por qué existe Archivo Vivo | 📝 | ~1,129 |

---

## BLOQUE A — El territorio y sus ciudades (nodos 001–002)

*Las ciudades mayas, la conquista y el nombre del lugar.*
...
## BLOQUE B — Los personajes que el municipio olvidó (nodos 002–006)

*Los apellidos del poder, los que resistieron y los que cruzaron el mar.*
...
## Capítulos no iniciados 🔲

Los siguientes temas tienen base documental en los nodos pero aún no tienen borrador:

| Tema | Nodo fuente | Notas |
|---|---|---|
| La meliponicultura como resistencia — Leydy Pech y la abeja Xunáan Kab | 009, 010 | FX009 — Goldman Prize 2020 |
| La reforma agraria en Los Chenes — ejidos, chicle y recampesinación | 004 | Schüren 2003 [F056] |
| Los menonitas y la transformación del territorio (1987–2026) | 005 | F061, F062 |
| Los censos como poder — demografía y control colonial | 008 | INEGI histórico |
| Santa Rosa Xtampak — la capital regional que nadie recuerda | 001 | IAI Berlin 2020-2022 [F059] |
| Juan Yam y la rebelión de Sahcabchén (1669) — los bataboob que resistieron | 002, 009 | AGI México 3050 [F054] |

---

## Resumen global

| | Cantidad | Palabras aprox. |
|---|---|---|
| Capítulos aprobados | **17** | ~38,420 |
| Capítulos en borrador | **7** | ~11,613 |
| Capítulos no iniciados | **~6** | — |
| **Total escrito** | **24** | **~50,033** |

> A ~250 palabras por página, el material aprobado equivale a **~154 páginas**.  
> Con borradores incluidos, el material escrito totaliza **~200 páginas**.

---

## Hilos narrativos (conexiones entre capítulos)

| Hilo | Capítulos que lo desarrollan |
|---|---|
| **HIL001** Cuba y el tráfico de mayas | B1, B-Madruga, B-Serapio |
| **HIL002** Familia Lara y el poder chenero | B-LZavala, B2, B4, B8, B9 |
| **HIL004** Apellidos del poder | B1, B2, B4, B8, B9, B11 |
| **HIL005** El silencio como mecanismo | Todos los B |
| **HIL007** Bataboob y resistencia maya | B-Madruga, B12 |
| **HIL009** Familia Baqueiro | B-Serapio, B-Oswaldo, B5, B8 |

---

## Correspondencia con nodos históricos

| Nodo | Período | Capítulos que lo cubren |
|---|---|---|
| 001 Prehispánico | ~1000 a.C.–1517 | A1, A2, A3 |
| 002 Conquista | 1517–1669 | A4, A5, B-Madruga, B12 |
| 003 Colonia–Porfiriato | 1670–1910 | B1, B2, B3, B9, B-Serapio |
| 004 Revolución–Chicle | 1910–1970 | B4, B11 |
| 005 Contemporáneo | 1970–2026 | *(pendiente)* |
| 006 Poder político | 1959–2026 | B8, B9, B11 |
| 007 Rutas y territorio | 1517–2026 | A6, B6 |
| 008 Demografía | 300 a.C.–2026 | *(pendiente)* |
| 009 Resistencia maya | 1669–2026 | B12, *(pendiente)* |
| 010 Conocimiento y cultura | 300 a.C.–2026 | B5, B7 |
