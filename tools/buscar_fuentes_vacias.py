...
try:
    ...
    _FirecrawlApp = None  # type: ignore[assignment]
    _FIRECRAWL_OK = False
...
def guardar_reporte(resultados: list[dict], registros_detectados: int) -> Path:
    ...
    reporte = {
        ...
        "nota_metodologica": (
            ...
            "Open Library, DuckDuckGo y Firecrawl (cuando la clave API está disponible). "
            "Las fuentes candidatas deben verificarse "
